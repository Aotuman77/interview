...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.266d57b19cafda73a0cb539bf4e0a1422d1ef6ed065c5c04d6a2398e8db77125.js',function(){input.required=false;search();});}
